---
description: Create a spec file and feature branch for the next revify step
...
Spendly expense tracker. Always follow the rules in CLAUDE.md if any.
...
- All templates extend `landing.html`
